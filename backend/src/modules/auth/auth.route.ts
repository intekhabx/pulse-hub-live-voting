...
import { exchangeOauthOtpDto, linkOauthAccountDto, loginDto, registerDto, resendOtpDto, updateUserDetailsDto, updateUserPasswordDto, verifyOtpDto } from './auth.dto';
