                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <button
                      key={name}
                      type="button"
                      onClick={() => window.location.href = `${import.meta.env.VITE_API_URL}/api/auth/${provider}-login`}
                      className={`flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium border transition-all duration-200 cursor-pointer ${
                        dark
