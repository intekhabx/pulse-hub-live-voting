...
export function PollDetailsSection({ pollId }: PollDetailsSectionProps) {
  ...
  if (
    ...
    !poll.analytics ||
    poll?.analytics.length <=0
  ) {
    return (
      <div className="mx-auto flex min-h-[70vh] max-w-6xl items-center justify-center">
        <div className="rounded-2xl border border-dashed border-white/10 bg-[#13131f] px-10 py-12 text-center">
          ...
          <p className="mt-2 max-w-md text-sm text-gray-500">
            Analytics will appear here once people start responding to your
            poll.
          </p>
        </div>
      </div>
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="mb-2 flex items-center gap-3">
            <span
              className="text-xs font-semibold uppercase tracking text-orange-400">
              Poll Analytics
            </span>
      ...
      <div
        ...
        <div
          className="rounded-xl border border-white/[0.08] bg-[#13131f] p-4">
        ...
        >
          ...
          <h2
            className="mt-2 text-2xl font-bold text-violet-400"
          >
      ...
      {/* Distribution */}
      <div
        className="rounded-xl border border-white/[0.08] bg-[#13131f] p-5"
      >
        <div className="mb-5">
          <h3
        ...
        >
          ...
          >
            {/* Auth */}
            <div
              className="flex items-center justify-between rounded-xl border border-orange-500/20 bg-orange-500/[0.05] px-4 py-3"
            >
            ...
            {/* Anonymous */}
            <div
              className="flex items-center justify-between rounded-xl border border-violet-500/20 bg-violet-500/[0.05] px-4 py-3"
            >
              <div className="flex items-center gap-3">
                <span
          ...
          >
            <div
              className="flex h-28 w-28 flex-col items-center justify-center rounded-full bg-[#13131f]"
            >
              <span
      ...
      >
        {poll.analytics.map((obj, index) => (
          ...
          >
            ...
            >
              <div
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-violet-500/10 text-xs font-bold text-violet-400"
              >
                {index + 1}
              </div>
                ...
                <div key={option.optionId}>
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="rounded-md border border-orange-500/20 bg-orange-500/10 px-2 py-1 text-[11px] font-semibold text-orange-400">
